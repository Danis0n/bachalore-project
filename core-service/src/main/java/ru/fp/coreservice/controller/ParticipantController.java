...
public class ParticipantController {
    ...
    @PostMapping("account/{bic}/{currency}")
    public void openAccount(@PathVariable String bic, @PathVariable String currency) {
        participantService.openAccount(bic, currency);
    }

    @ResponseStatus(HttpStatus.OK)
    @DeleteMapping("account/{bic}/{accountCode}")
    public void closeAccount(@PathVariable String bic, @PathVariable String accountCode) {
        participantService.closeAccount(bic, accountCode);
    }
