...
import {Container, Nav, Navbar, NavDropdown, Row, Col, ButtonGroup} from "react-bootstrap";
            ...
            <Container>
                ...
                <Nav className="me-auto">
                    ...
                    <NavDropdown title={t('navigation.actions')}>
                        ...
                        <NavDropdown.Item as={Link} to="/participants">{t('navigation.participants')}</NavDropdown.Item>
                        <NavDropdown.Item as={Link} to="/incoming-message">{t('navigation.incoming_messages')}</NavDropdown.Item>
                        <NavDropdown.Item as={Link} to="/outgoing-message">{t('navigation.outgoing_messages')}</NavDropdown.Item>
